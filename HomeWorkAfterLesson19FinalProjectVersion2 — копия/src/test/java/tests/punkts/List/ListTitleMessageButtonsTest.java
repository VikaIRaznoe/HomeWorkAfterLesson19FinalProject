...
public class ListTitleMessageButtonsTest {
    ...
    public void listTitleMessageButtonsTest() {
        ListTitleScreen listTitleScreen = new ListTitleScreen(driver);
    ...
    public void listTitleMessageButtonsQuestionTest() {
        ListTitleScreen listTitleScreen = new ListTitleScreen(driver);
        listTitleScreen.clickButton();
